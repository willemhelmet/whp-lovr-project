...
function m:volume()
  ...
  for i = 1, #self.ilist, 3 do
    ...
    local v2 = vec3(self.vlist[self.ilist[i + 1]][1], self.vlist[self.ilist[i + 1]][2], self.vlist[self.ilist[i + 1]][3]) -
    centroid
    local v3 = vec3(self.vlist[self.ilist[i + 2]][1], self.vlist[self.ilist[i + 2]][2], self.vlist[self.ilist[i + 2]][3]) -
    centroid
